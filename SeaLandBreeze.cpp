...
string msg[6] = { "COMPUTER GRAPHICS MINI PROJECT","TOPIC: DEMONSTRATION OF LAND & SEA BREEZE","       DURING DAY AND NIGHT","By","Dhanraj Gedam and Kumar Dhananjaya","PRESS [S] TO START" };
...
void myDisplay(void)
{
	if (sprgm == 1)
	{
		...
		draw_house(200, 310, 0.8, 0.3, 0.5);
